...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    sellLand: "Sell Land",
    sellLandNavBadge: "Post Free",
    sellLandTitle: "Sell Your Land / Plot",
    sellLandSubtitle: "Connect directly with verified buyers across MP & India. Free listing assistance.",
  ...
  hi: {
    ...
    sellLand: "जमीन बेचें",
    sellLandNavBadge: "निशुल्क पोस्ट",
    sellLandTitle: "अपनी जमीन / प्लॉट बेचें",
    sellLandSubtitle: "मध्य प्रदेश और पूरे देश के सत्यापित खरीदारों से सीधे जुड़ें। निशुल्क लिस्टिंग सहायता।",
