...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    sellLandSubtitle: "Connect directly with verified buyers across MP & India with complete assistance.",
  ...
  hi: {
    ...
    sellLandSubtitle: "मध्य प्रदेश और देश के सत्यापित खरीदारों से सीधे जुड़ें। लिस्टिंग सहायता उपलब्ध।",
